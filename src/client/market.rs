...
use crate::{
    error::Error,
    model::{BookTickers, KlineSummaries, KlineSummary, OrderBook, PriceStats, Prices, Ticker, AggTradeHistory},
};
...
impl Binance {
    ...
    pub fn get_historical_trades<I, L>(
        &self,
        symbol: &str,
        limit: I,
        from_id: L
    ) -> Fallible<impl Future<Output = Fallible<Vec<AggTradeHistory>>>>
        where
            I: Into<Option<u16>>,
            L: Into<Option<u64>>,
    {
